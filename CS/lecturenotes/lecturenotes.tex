...
\end{itemize}
\newpage
\section{Recursion: 11/7/25}
\textbf{Recursion:} A function that calls itself. 
\begin{itemize}
    \item Base Case: The condition under which the function stops calling itself.
    \item Recursive Case: The part of the function where it calls itself with modified arguments.
\end{itemize}
